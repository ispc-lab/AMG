...
from spinningup.spinup.utils.mpi_tools import mpi_fork, mpi_avg, num_procs
import time
import numpy as np
...
if __name__ == '__main__':    
    ...
    parser.add_argument('--log_dir', type=str, default='./logs_')
    ...
    for epoch in tqdm(range(config.RL.epochs + 1)):
