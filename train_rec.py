...
if __name__ == '__main__':
    ...
    parser.add_argument('--logdir', type=str, default='./logs/ablations/wo_ligandPR/')
    parser.add_argument('--vocab_path', type=str, default='dataset/vocab_pretrain.txt')
    parser.add_argument('--PR_ligand_path', type=str, default=None, 
                        help='Load pretrained model of ligand')
    parser.add_argument('--PR_pocket_path', type=str, default='./ckpts/pretrained_pocket_ckpt.pt', 
