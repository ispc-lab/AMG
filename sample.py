...
if __name__ == '__main__':    
    ...
    parser.add_argument('--data_id_start', type=str, default=0)
    parser.add_argument('--data_id_end', type=str, default=99)
    ...
    data_ids = range(args.data_id_start, args.data_id_end+1)
